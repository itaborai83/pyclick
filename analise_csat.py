...
class App(object):
    ...
    PERIODOS = [ "FEV", "MAR", "ABR", "MAIO", "JUN", "JUL", "AGO", "SET", "OUT", "NOV", "DEZ" ]
    RANGES = {
        "FEV":  ('2020-01-31 00:00:00', '2020-02-25 23:59:59'),
    ...
    RANGES_ACC = {
        "FEV":  ('2020-01-31 00:00:00', '2020-02-25 23:59:59'),
        "MAR":  ('2020-01-31 00:00:00', '2020-03-25 23:59:59'),
        "ABR":  ('2020-01-31 00:00:00', '2020-04-25 23:59:59'),
        "MAIO": ('2020-01-31 00:00:00', '2020-05-25 23:59:59'),
        "JUN":  ('2020-01-31 00:00:00', '2020-06-25 23:59:59'),
        "JUL":  ('2020-01-31 00:00:00', '2020-07-25 23:59:59'),
        "AGO":  ('2020-01-31 00:00:00', '2020-08-25 23:59:59'),
        "SET":  ('2020-01-31 00:00:00', '2020-09-25 23:59:59'),
        "OUT":  ('2020-01-31 00:00:00', '2020-10-25 23:59:59'),
        "NOV":  ('2020-01-31 00:00:00', '2020-11-25 23:59:59'),
        "DEZ":  ('2020-01-31 00:00:00', '2020-12-31 23:59:59'),
    }
    ...
    def calc_kpi(self, mesa, start_date, end_date, df):
        assert start_date <= end_date
        if mesa is None:
            df = df[ df[ 'data_resposta' ].between(start_date, end_date) ].copy()
        else:
            df = df[ ( df[ 'mesa_acao' ] == mesa ) & ( df[ 'data_resposta' ].between(start_date, end_date) ) ].copy()
        non_breached = len(df[ df[ 'avaliacao' ].ge(self.THRESHOLD_KPI) ])
        breached     = len(df[ df[ 'avaliacao' ].lt(self.THRESHOLD_KPI) ])
    ...
    def generate_table(self, mesas, pesquisas_df, acc):
        if acc:
        ...
        for mesa in mesas:
            ...
            for periodo in self.PERIODOS:
                ...
                kpi, qtd = self.calc_kpi(mesa, start_date, end_date, pesquisas_df)
    ...
    def save(self, pesquisas_df, csat_df, csat_acc_df):
    ...
    def run(self):
        try:
            ...
            csat_df = self.generate_table(mesas, pesquisas_df, acc=False)
            csat_acc_df = self.generate_table(mesas, pesquisas_df, acc=True)
            self.save(pesquisas_df, csat_df, csat_acc_df)
