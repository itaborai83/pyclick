...
SQL_UPDATE_DESIGNADO        = util.get_query("CONSOLIDA__UPDATE_DESIGNADO_ATUAL")
...
class App(object):
    ...
    def fill_table(self, conn, df):
        ...
        logger.info('preenchend campo DESIGNADO da tabela REL_MEDICAO')
        conn.executescript(SQL_UPDATE_DESIGNADO)        
