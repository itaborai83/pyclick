...
class CalcDurationTest(unittest.TestCase):
    ...
    def test_it_converts_a_datetime_range_into_seconds(self):
        seconds = convert_to_seconds('2000-01-01 00:00:00') - convert_to_seconds('2000-01-01 00:00:00')
        self.assertEqual(seconds, 0)
        seconds = convert_to_seconds('2000-01-01 00:00:30') - convert_to_seconds('2000-01-01 00:00:00')
        self.assertEqual(seconds, 30)
        seconds = convert_to_seconds('2000-01-01 00:00:31') - convert_to_seconds('2000-01-01 00:00:00')
        self.assertEqual(seconds, 31)
        seconds = convert_to_seconds('2000-01-01 00:01:29') - convert_to_seconds('2000-01-01 00:00:00')
        self.assertEqual(seconds, 60+29)
        
        seconds = convert_to_seconds('2000-01-01 00:00:15') - convert_to_seconds('2000-01-01 00:00:15')
        self.assertEqual(seconds, 0)
        seconds = convert_to_seconds('2000-01-01 00:00:45') - convert_to_seconds('2000-01-01 00:00:15')
        self.assertEqual(seconds, 45-15)
        seconds = convert_to_seconds('2000-01-01 00:00:46') - convert_to_seconds('2000-01-01 00:00:15')
        self.assertEqual(seconds, 46-15)
        seconds = convert_to_seconds('2000-01-01 00:01:44') - convert_to_seconds('2000-01-01 00:00:15')
        self.assertEqual(seconds, 60+44-15)
        
        seconds = convert_to_seconds('2000-01-01 01:00:15') - convert_to_seconds('2000-01-01 00:00:15')
        self.assertEqual(seconds, 60*60)
        seconds = convert_to_seconds('2000-01-01 01:00:45') - convert_to_seconds('2000-01-01 00:00:15')
        self.assertEqual(seconds, 60*60+45-15)
        seconds = convert_to_seconds('2000-01-01 01:00:46') - convert_to_seconds('2000-01-01 00:00:15')
        self.assertEqual(seconds, 60*60+46-15)
        seconds = convert_to_seconds('2000-01-01 01:01:44') - convert_to_seconds('2000-01-01 00:00:15')
        self.assertEqual(seconds, 60*60+60+44-15)
