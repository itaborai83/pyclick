...
SELECT	'PRP' AS INDICADOR, 1 AS ORDEM, PRP AS VALOR, 10.0 as SLA
,		'Violações ' 					|| VIOLACOES  || 
...
INSERT OR REPLACE INTO INDICADORES(INDICADOR, ORDEM, VALOR, SLA, OBSERVACAO)  
SELECT	'PRO' AS INDICADOR, 2 AS ORDEM, PRO AS VALOR, 15.0 as SLA
,		'Violações ' 					|| VIOLACOES  	|| 
		' / Incidentes '				|| INCIDENTES 	||
		' > Encerrados: ' 				|| ENCERRADOS 	|| 
		' | Resolvidos: ' 				|| RESOLVIDOS 	|| 
...
INSERT OR REPLACE INTO INDICADORES(INDICADOR, ORDEM, VALOR, SLA, OBSERVACAO)  
SELECT	'PRC' AS INDICADOR, 3 AS ORDEM, PRC AS VALOR, 25.0 as SLA
,		'Violações ' 					|| VIOLACOES  	|| 
		' / Incidentes '				|| INCIDENTES 	||
		' > Encerrados: ' 				|| ENCERRADOS 	|| 
		' | Resolvidos: ' 				|| RESOLVIDOS 	|| 
...
INSERT OR REPLACE INTO INDICADORES(INDICADOR, ORDEM, VALOR, SLA, OBSERVACAO)  
SELECT	'PRS' AS INDICADOR, 4 AS ORDEM, PRS AS VALOR, 10.0 AS SLA
,		'Violações ' 					|| VIOLACOES  	|| 
		' / Incidentes '				|| INCIDENTES 	||
		' > Encerrados: ' 				|| ENCERRADOS 	|| 
		' | Resolvidos: ' 				|| RESOLVIDOS 	|| 
...
INSERT OR REPLACE INTO INDICADORES(INDICADOR, ORDEM, VALOR, SLA, OBSERVACAO)  
SELECT	'IDS' AS INDICADOR, 8 AS ORDEM, IDS AS VALOR, 170.0 as SLA
